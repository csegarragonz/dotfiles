set spell
nnoremap <buffer> <C-c> :! ~/git/csegarragonz/dotfiles/tex/compile_tex_docker.sh '%:t'<CR>
nnoremap <buffer> <C-d> :! ~/git/csegarragonz/dotfiles/tex/compile_tex_docker.sh clean<CR>
